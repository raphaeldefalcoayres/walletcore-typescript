...
describe("ValidatorRules Unit Tests", () => {
    ...
    test("required validation rule", () => {
        ...
        const error = new errors_1.ValidationError("The field is required");
    ...
    test("string validation rule", () => {
        ...
        const error = new errors_1.ValidationError("The field must be a string");
        arrange.forEach((item) => {
            assertIsInvalid({
                value: item.value,
                property: item.property,
    ...
    test("maxLength validation rule", () => {
        ...
        const error = new errors_1.ValidationError("The field must be less or equal than 5 characters");
        arrange.forEach((item) => {
            assertIsInvalid({
                value: item.value,
                property: item.property,
    ...
    test("boolean validation rule", () => {
        ...
        const error = new errors_1.ValidationError("The field must be a boolean");
        arrange.forEach((item) => {
            assertIsInvalid({
                value: item.value,
                property: item.property,
    ...
    it("should throw a validation error when combine two or more validation rules", () => {
        ...
        }).toThrow(new errors_1.ValidationError("The field is required"));
        validator = validator_rules_1.default.values(5, "field");
        expect(() => {
            validator.required().string().maxLength(5);
        }).toThrow(new errors_1.ValidationError("The field must be a string"));
        validator = validator_rules_1.default.values("aaaaaa", "field");
        expect(() => {
            validator.required().string().maxLength(5);
        }).toThrow(new errors_1.ValidationError("The field must be less or equal than 5 characters"));
        ...
        expect(() => {
            validator.required().boolean();
        }).toThrow(new errors_1.ValidationError("The field must be a boolean"));
    });
