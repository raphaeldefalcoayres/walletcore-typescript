...
const client_fake_builder_1 = require("./client-fake-builder");
...
describe("ClientFakerBuilder Unit Tests", () => {
    describe("uuid prop", () => {
        ...
        test("withUUID", () => {
            ...
            expect($this).toBeInstanceOf(client_fake_builder_1.ClientFakeBuilder);
        ...
        it("should pass index to uuid factory", () => {
            ...
            mockFactory = jest
                .fn()
                .mockReturnValue("2f8453f4-6e42-4742-bb91-c1b5caa2ddce");
            const fakerMany = client_fake_builder_1.ClientFakeBuilder.theCategories(2);
    ...
    describe("created_at prop", () => {
        ...
        it("should throw error when any with methods has called", () => {
            const fakerClient = client_fake_builder_1.ClientFakeBuilder.aClient();
            expect(() => fakerClient.created_at).toThrow(new Error("Property created_at not have a factory, use 'with' methods"));
        });
        it("should be undefined", () => {
    ...
    it("should create many clients", () => {
        const faker = client_fake_builder_1.ClientFakeBuilder.theCategories(2);
        const uniqueEntityId = "2f8453f4-6e42-4742-bb91-c1b5caa2ddce";
